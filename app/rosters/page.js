...
export default function RostersPage() {
  ...
  const BG = (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <img src="/roster-bg.png" alt="" className="fixed top-0 left-1/2 -translate-x-1/2 opacity-20 select-none pointer-events-none" style={{width:"1080px",height:"1920px"}}/>
    </div>
  );
  ...
  // Hub view
  return (
    <main className="min-h-screen overflow-x-hidden w-full max-w-full bg-gradient-to-b from-[#0b1020] via-[#070b17] to-[#05070f] text-white p-6 pb-6">
      {BG}
      <AppHeader/>
