...
function RatingTooltip() {
  ...
  return (
    <div className="relative">
      ...
      {show && (
        <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 z-50 w-48 rounded-lg border border-white/10 bg-[#0d1424]/95 backdrop-blur-xl shadow-xl p-3">
...
function IconStatBox({ label, value, iconKey, colourKey = "slate" }) {
  ...
  return (
    <div className={`rounded-lg border ${c.border} ${c.bg} p-2.5 flex flex-col h-full`}>
...
function StatBox({ label, value, colour = "text-white", sub = null }) {
  return (
    <div className="rounded-lg border border-white/10 bg-white/[0.04] p-2.5 flex flex-col items-center justify-center text-center h-full">
...
export default function PlayerProfilePage() {
  ...
  if (loading) return (
    <main className="pb-16 min-h-screen bg-gradient-to-b from-[#0b1020] via-[#070b17] to-[#05070f] flex items-center justify-center">
